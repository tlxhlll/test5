...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        miniDouyinService.postVideo("18888911367", "tjc1411", coverImagePart, videoPart).enqueue(
                ...
                if (response.body() != null && response.body().videos != null) {
                    ...
                    for (int i = 0; i < mVideos.size(); i++) {
                        Log.d(TAG, "onResponse: "
                                + mVideos.get(i).userName + "   "
                                + mVideos.get(i).studentId + "   "
                                + mVideos.get(i).imageUrl + "   "
                                + mVideos.get(i).videoUrl + "   "
                                + mVideos.get(i).imageHeight + "   "
                                + mVideos.get(i).imageWidth);
                        if (!"18888911367".equals(mVideos.get(i).studentId)) {
                            mVideos.remove(i--);
                        }
                    }
